...
const styles = StyleSheet.create({
  ...
  tabBarWrapper: {
    borderBottomWidth: StyleSheet.hairlineWidth,
    borderBottomColor: 'rgba(140,170,255,0.12)',
  },
  tabBar: {
  ...
  tab: {
    ...
    borderColor: 'rgba(140,170,255,0.15)',
  },
  tabFillActive: {
  ...
  itemRow: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(12,20,60,0.7)',
    paddingRight: 12,
  },
  itemMain: {
    flex: 1,
  ...
  itemThumb: { width: 38, height: 38, borderRadius: 8, backgroundColor: 'rgba(15,28,80,0.6)', flexShrink: 0 },
  itemName: { flex: 1, fontSize: 16, color: '#dce8ff' },
  itemNameChecked: { textDecorationLine: 'line-through', color: 'rgba(150,175,220,0.3)' },
  deleteBtn: { padding: 6 },

  empty: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: 8 },
  emptyTitle: { fontSize: 17, fontWeight: '600', color: 'rgba(150,175,220,0.6)' },
  emptyHint: { fontSize: 14, color: 'rgba(150,175,220,0.4)', textAlign: 'center', paddingHorizontal: 40 },
  emptyBtn: {
    marginTop: 8,
  ...
  emptyBtnText: { color: 'rgba(200,220,255,0.95)', fontSize: 15, fontWeight: '500' },
  emptyList: { paddingTop: 60, alignItems: 'center' },
  emptyListText: { fontSize: 14, color: 'rgba(150,175,220,0.35)', textAlign: 'center', paddingHorizontal: 40 },

  addBar: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(10,16,48,0.95)',
  ...
  sheetTitle: { fontSize: 17, fontWeight: '700', color: '#dce8ff', marginBottom: 16 },
  inputGroup: {
    borderWidth: StyleSheet.hairlineWidth,
  ...
  inputGroupOpen: { backgroundColor: 'rgba(15,28,80,0.8)' },
  storeInput: { paddingHorizontal: 14, paddingVertical: 12, fontSize: 16, color: '#e8f0ff' },
  suggestionFirst: {
    borderTopWidth: StyleSheet.hairlineWidth,
    borderTopColor: 'rgba(140,170,255,0.15)',
  },
  ...
  suggestionText: { fontSize: 15, color: '#dce8ff', flex: 1 },

  dateLabel: { fontSize: 13, color: 'rgba(150,175,220,0.45)', marginBottom: 8 },
  ...
  dateChipText: { fontSize: 13, fontWeight: '500', color: 'rgba(150,175,220,0.55)' },
  dateChipTextActive: { color: 'rgba(200,220,255,0.95)' },
  ...
  createBtnText: { color: 'rgba(200,220,255,0.95)', fontSize: 15, fontWeight: '500' },
  ...
  toast: {
    ...
    left: 16,
    right: 16,
    backgroundColor: 'rgba(10,16,48,0.97)',
    borderRadius: 12,
    borderWidth: StyleSheet.hairlineWidth,
    borderColor: 'rgba(140,170,255,0.2)',
    flexDirection: 'row',
  ...
  toastText: { color: '#dce8ff', fontSize: 14 },
  toastUndo: { color: 'rgba(180,210,255,0.8)', fontSize: 14, fontWeight: '600' },
})
